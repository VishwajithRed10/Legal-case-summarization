...
class T5FineTuner(pl.LightningModule):
    ...
    #              *args, **kwargs):
        ...
        self.model = T5ForConditionalGeneration.from_pretrained(self.args.sum_model,forced_bos_token_id=0)#model_name)
        self.tokenizer = T5TokenizerFast.from_pretrained(self.args.sum_model)#model_name)
