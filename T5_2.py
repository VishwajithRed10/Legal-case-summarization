...
from drive.MyDrive.Group_24.preprocessor import tokenize, yield_sentence_pair, yield_lines, load_preprocessor, read_lines, \
...
import random
import nltk
from drive.MyDrive.Group_24.preprocessor import  get_data_filepath
...
from drive.MyDrive.Group_24.Ts_T5 import T5FineTuner
...
class SumSim(pl.LightningModule):
    def __init__(self,args):
        ...
        self.simplifier = T5FineTuner.load_from_checkpoint('/content/drive/MyDrive/easy-summary-main/SimSum/experiments/T5Baseline_exp_1713955216794340/checkpoint-epoch=0.ckpt')
