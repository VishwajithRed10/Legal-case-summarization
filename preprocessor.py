...
RESOURCES_DIR = REPO_DIR / '/content/drive/MyDrive/Group_24/resources'
EXP_DIR = REPO_DIR / '/content/drive/MyDrive/Group_24/experiments'
DATASETS_DIR = REPO_DIR / '/content/drive/MyDrive/Group_24/data'

OUTPUT_DIR = REPO_DIR / '/content/drive/MyDrive/Group_24/output'
DUMPS_DIR = RESOURCES_DIR / "/content/drive/MyDrive/Group_24/DUMPS"
